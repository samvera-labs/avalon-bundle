  ...
  describe '#display_content' do
    ...
    context 'with a file' do
      ...
      context 'when the file is an audio derivative with metadata' do
        let(:files_metadata) { [{ id: '1', label: 'high', external_file_uri: 'http://test.com/high.mp3' },
                                { id: '2', label: 'medium', external_file_uri: 'http://test.com/medium.mp3'}].to_json }
        let(:solr_document) { SolrDocument.new(id: '12345', duration_tesim: 1000, files_metadata_ssi: files_metadata) }
